...
public class OdsMesSupplychainMaterialWipBarcode {
    public static void main(String[] args) {
        ...
        env.getCheckpointConfig().setCheckpointStorage(
                checkpointAddress + "ods_mes_supplychain_material_wip_barcode"
        );
        ...
        String destinationSql = "CREATE TABLE doris_ods_mes_supplychain_material_wip_barcode (\n" +
                "KID decimal," +
                "CREATED_BY decimal," +
                "CREATION_DATE timestamp," +
